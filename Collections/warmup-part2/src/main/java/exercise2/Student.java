...
public class Student {
    ...
    public String toString() {
        return "Student id: "+this.id+"|| Student name: "+this.firstName+" "+this.lastName+"|| Student avg grade: "+this.averageGrade;
    }
    ...
    public boolean equals(Object o) {
        ...
        if(s.getId().equals(id) && s.getAverageGrade().equals(averageGrade) && firstName.equals(s.getFirstName()) && lastName.equals(s.getLastName()))
            return true;
        return false;
    ...
    public int hashCode() {
        ...
        result = result*31 + this.getFirstName().hashCode();
        return result;
    }
